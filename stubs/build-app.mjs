 ...
 *
 * Usage: node .cloudflare/build-app.mjs
 *
 * Output: .cloudflare/dist/assets/app.tar.gz
 *
 * Configuration is read from .cloudflare/build-config.json (generated by laraworker:build).
 */
